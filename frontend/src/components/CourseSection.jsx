...
const CourseSection = () => {
  ...
  if (loading) {
    return <div className="text-center mt-20 text-xl font-semibold text-gray-600">Loading courses...</div>;
  }
  if (!courses || courses.length === 0) {
    return <div className="text-center mt-10 text-xl font-semibold text-gray-800">No courses available.</div>;
  }
